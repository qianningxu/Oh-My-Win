...
final class WinMuxOverlayPaletteTest: XCTestCase {
    ...
    func testResizePreviewUsesDocumentedGeistRoles() {
        assertSameColor(ResizePreviewPalette.shadeFillNSColor, NSColor(calibratedWhite: 1, alpha: 0.50))
    ...
    func testGlassBarsUseExpandedDimensions() {
        ...
        XCTAssertEqual(WinMuxGlassStyle.workspaceBar.surfaceOpacity, 0.80)
