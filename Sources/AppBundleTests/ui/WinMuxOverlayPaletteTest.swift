...
final class WinMuxOverlayPaletteTest: XCTestCase {
    ...
    func testGlassBarsUseExpandedDimensions() {
        ...
        XCTAssertEqual(WinMuxBarStyle.unfocusedWindowBarOpacity, 0.025)
        ...
        XCTAssertEqual(WinMuxGlassStyle.untintedClear.recipe.blurOpacity, 1)
        XCTAssertEqual(WinMuxGlassStyle.untintedClear.recipe.whiteTintOpacity, 0)
