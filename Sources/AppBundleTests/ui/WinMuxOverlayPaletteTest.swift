...
final class WinMuxOverlayPaletteTest: XCTestCase {
    ...
    func testGlassBarsUseExpandedDimensions() {
        ...
        XCTAssertEqual(WinMuxGlassStyle.workspaceBar.recipe.blurOpacity, 0.60)
        XCTAssertEqual(WinMuxGlassStyle.workspaceBar.recipe.whiteTintOpacity, 0.20)
        XCTAssertEqual(WinMuxGlassStyle.workspaceBar.recipe.shadowOpacity, 0.16)
