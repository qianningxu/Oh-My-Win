...
final class WinMuxOverlayPaletteTest: XCTestCase {
    ...
    func testGlassBarsUseExpandedDimensions() {
        ...
        XCTAssertEqual(WinMuxBarStyle.windowSelectedSegmentOpacity, 0.05)
        XCTAssertEqual(WinMuxBarStyle.windowTabHoveredSegmentOpacity, 0.25)
        XCTAssertEqual(WinMuxBarStyle.windowBarOpacity, 0.05)
        XCTAssertEqual(WinMuxBarStyle.focusedWindowTabOpacity, 0.80)
        XCTAssertEqual(WinMuxBarStyle.hoveredWindowTabOpacity, 0.50)
        XCTAssertEqual(WinMuxBarStyle.unfocusedWindowTabOpacity, 0.20)
