...
final class WinMuxOverlayPaletteTest: XCTestCase {
    ...
    func testGlassBarsUseExpandedDimensions() {
        ...
        XCTAssertEqual(WinMuxBarStyle.workspaceBarStrokeOpacity, 0.40)
        XCTAssertEqual(WinMuxGlassStyle.workspaceBar.recipe.blurOpacity, 0.40)
        XCTAssertEqual(WinMuxGlassStyle.workspaceBar.recipe.whiteTintOpacity, 0.40)
        XCTAssertEqual(WinMuxGlassStyle.workspaceBar.recipe.shadowOpacity, 0.10)
        XCTAssertEqual(WinMuxGlassStyle.workspaceBar.recipe.shadowRadius, WinMuxSpacing.compact)
