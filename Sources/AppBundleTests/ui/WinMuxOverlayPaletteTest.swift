...
final class WinMuxOverlayPaletteTest: XCTestCase {
    ...
    func testGlassBarsUseExpandedDimensions() {
        ...
        XCTAssertEqual(WinMuxBarStyle.workspaceTabUnfocusedTextOpacity, 0.80)
        XCTAssertEqual(WinMuxBarStyle.windowTabUnfocusedTextOpacity, 0.80)
        XCTAssertEqual(WinMuxGlassStyle.workspaceBar.recipe.blurOpacity, 0.80)
