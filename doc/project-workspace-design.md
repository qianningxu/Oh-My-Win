...
| Workspace tab bar / window bar | Row attached above a workspace window | Enlarged native clear-glass track with a lightly tinted active tab and equal-width tabs with centered content |
