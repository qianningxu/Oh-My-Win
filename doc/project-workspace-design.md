...
| Workspace tabs bar | Bottom bar containing the Project menu and workspace tabs | Centered content-sized WinDock clear-glass surface with 60% backdrop blur, a 20% white tint, and a soft outer edge shadow instead of a hard outline, floating 12 points above the usable screen edge; workspace labels use medium weight when active or hovered and regular weight otherwise, with a text-width underline for selection |
