...
| Window tab bar | Compact WinDock glass track at 5% overall opacity, with a color-neutral backdrop, 25% blur opacity, a 20% white tint, and an independently rendered 45% theme-aware border. Focused labels use 80% opacity, hovered unfocused labels use 50%, and unfocused labels use 20%; the active fill remains 5% and hover uses a 25% overlay. |
