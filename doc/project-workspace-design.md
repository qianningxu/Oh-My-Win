...
| Workspace tabs bar | Bottom bar containing the Project menu and workspace tabs | Centered content-sized WinDock clear-glass surface with 25% backdrop blur and a 20% white tint, without an outline, floating 12 points above the usable screen edge; workspace labels use medium weight when active or hovered and regular weight otherwise, with a text-width underline for selection |
