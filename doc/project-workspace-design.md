...
| Workspace tabs bar | Bottom bar containing the Project menu and workspace tabs | Centered content-sized WinDock glass surface with 40% backdrop blur, a 40% white tint, and a 40% theme-aware border plus a tight soft shadow composited from the same rounded silhouette, floating 12 points above the usable screen edge; workspace labels use medium weight when active or hovered and regular weight otherwise, without an underline treatment |
